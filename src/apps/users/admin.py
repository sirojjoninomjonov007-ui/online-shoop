...
class UserOTPVerificationsAdmin(admin.ModelAdmin):
    list_display = (
        "id", "user", "code", "attapts", "resend_attapts", 
        "for_forget_password", "for_forget_password_verified", 
        "expired_at", "created_at"
    )
    list_filter = ("for_forget_password", "for_forget_password_verified", "created_at", "expired_at")
...
class UserOTPIDVerificationsAdmin(admin.ModelAdmin):
    list_display = ("id", "user", "code", "attapts", "expired_at", "created_at")
...
class ChangePasswordLogsAdmin(admin.ModelAdmin):
    list_display = ("id", "user", "attapts", "is_changed", "expired_at", "error_expired_at", "created_at")
    list_filter = ("is_changed", "error_expired_at", "expired_at")
...
class ChangeEmailLogsAdmin(admin.ModelAdmin):
    list_display = (
        "id", "user", "old_email", "new_email", "code", 
        "attapts", "resend_attapts", "is_changed", 
        "expired_at", "created_at"
    )
    list_filter = ("is_changed", "expired_at")
    search_fields = ("user__username", "user__email", "old_email", "new_email", "code")
    readonly_fields = ("created_at",)
    ordering = ("-created_at",)